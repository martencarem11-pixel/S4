  ...
  fun updateTelemetryFromEngine(
    ...
    _telemetry.update {
      it.copy(
        ...
        depthOcclusionDetected = depthManager?.isDepthTextureReady ?: false,
        ...
        isDepthAvailable = isDepthAvailable || trackingData.isDepthEnabled || (depthManager?.isDepthTextureReady == true),
        ...
        isDepthConfidenceAvailable = false,
        depthConfidencePercentage = 0f,
        depthCoveragePercentage = depthManager?.occlusionPercentage ?: 0f,
